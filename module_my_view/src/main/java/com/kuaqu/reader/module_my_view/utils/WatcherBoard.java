...
public class WatcherBoard extends View {
    ...
    private float DpToPx(int value) {
        return ScreenUtils.dp2px(context,value);
    }
    ...
    private void paintPointer(Canvas canvas) {
        ...
        Log.e("矩形",rectFHour.left+"-->"+rectFHour.top+"-->"+rectFHour.right+"-->"+rectFHour.bottom);
    ...
    private void paintScale(Canvas canvas) {
        mPaint.setStrokeWidth(ScreenUtils.dp2px(context,1));
        int lineWidth = 0;
        for (int i = 0; i < 60; i++) {
            if (i % 5 == 0) { //整点
                mPaint.setStrokeWidth(ScreenUtils.dp2px(context,1.5f));
