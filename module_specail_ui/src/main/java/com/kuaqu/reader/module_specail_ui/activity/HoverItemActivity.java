...
import com.kuaqu.reader.module_specail_ui.adapter.HoverAdapter;
import com.kuaqu.reader.module_specail_ui.utils.CharacterParser;
import com.kuaqu.reader.module_specail_ui.utils.HoverItemBean;
import com.kuaqu.reader.module_specail_ui.utils.HoverItemDecoration;
import com.kuaqu.reader.module_specail_ui.utils.IndexView;
import com.kuaqu.reader.module_specail_ui.utils.PinyinComparator;
...
public class HoverItemActivity extends BaseActivity {
    ...
    private String[] names = new String[]{"阿妹", "b站","曹操","大黑牛","瓜皮","乎乎", "张三", "李四", "王五", "田鸡", "孙五","#liu"};
    ...
    private List<HoverItemBean> getData() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            userBean.setUserName(names[i % 11]);
