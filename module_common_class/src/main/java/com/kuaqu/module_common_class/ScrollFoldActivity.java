...
import com.kuaqu.module_common_class.adapter.ScrollFoldAdapter;
import com.kuaqu.reader.component_base.base.BaseActivity;

public class ScrollFoldActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scroll_fold);
    ...
    //主要有三种状态：第一个高亮状态改变，滑动时第二个字体高度变化，第三个全部为基础状态
    private void changeItemState(){
        ...
        Log.e("ssssop","进入"+firstVisibleOffset+"--->"+changeheight);
        // 减少当前展示的第一个item的高度。
        if (first == null) {
            return;
        }
